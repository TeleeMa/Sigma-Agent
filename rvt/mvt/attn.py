...
if __name__ == "__main__":
    a = torch.ones(4, 512, 7, 7)
    up0 = Conv2DBlock(512, 3, 31, 1, norm=None, activation='lrelu')
    up1 = nn.Upsample(scale_factor=32, mode="bilinear", align_corners=False)
    up2 = Conv2DBlock(3, 3, 31, 1, norm=None, activation='lrelu')
    res = up0(a)
    pdb.set_trace()
    res = up1(res)
    res = up2(res)
