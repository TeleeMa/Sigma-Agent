...
from mvq_former.mvq_former_single import MVQ_Former as MVQ_Former_Single
...
class MVQ_Former(nn.Module):
    def __init__(
        ...
        self.mvt1 = MVQ_Former_Single(**args, renderer=self.renderer)
    ...
    def forward(
        ...
        **kwargs,
        ...
        if pc_tp1 is not None:
            ...
            out = self.mvt1(img=img, img_tp=img_tp1, proprio=proprio, lang_emb=lang_emb, lang_token=lang_token, **kwargs)
        else:
            out = self.mvt1(img=img, proprio=proprio, lang_emb=lang_emb, lang_token=lang_token, **kwargs)
